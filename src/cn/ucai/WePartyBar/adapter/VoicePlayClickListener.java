...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(cn.ucai.WePartyBar.R.drawable.chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(cn.ucai.WePartyBar.R.drawable.chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	private void showAnimation() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(cn.ucai.WePartyBar.R.anim.voice_from_icon);
		} else {
			voiceIconView.setImageResource(cn.ucai.WePartyBar.R.anim.voice_to_icon);
		}
	...
	public void onClick(View v) {
		String st = activity.getResources().getString(cn.ucai.WePartyBar.R.string.Is_download_voice_click_later);
		if (isPlaying) {
