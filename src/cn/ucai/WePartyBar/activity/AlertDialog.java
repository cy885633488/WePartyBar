...
import cn.ucai.WePartyBar.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.WePartyBar.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.ucai.WePartyBar.R.id.title);
		mButton = (Button) findViewById(cn.ucai.WePartyBar.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.ucai.WePartyBar.R.id.image);
		editText = (EditText) findViewById(cn.ucai.WePartyBar.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.ucai.WePartyBar.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.ucai.WePartyBar.R.id.alert_message)).setVisibility(View.GONE);
