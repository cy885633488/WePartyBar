...
public class BlacklistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.WePartyBar.R.layout.activity_black_list);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getMenuInflater().inflate(cn.ucai.WePartyBar.R.menu.remove_from_blacklist, menu);
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.ucai.WePartyBar.R.id.remove) {
	...
	void removeOutBlacklist(final String tobeRemoveUser) {
	    ...
	    pd.setMessage(getString(cn.ucai.WePartyBar.R.string.be_removing));
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            pd.dismiss();
                            Toast.makeText(getApplicationContext(), cn.ucai.WePartyBar.R.string.Removed_from_the_failure, 0).show();
                        }
                    });
                }
            }
	...
	private class BlacklistAdapater extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = View.inflate(getContext(), cn.ucai.WePartyBar.R.layout.row_contact, null);
			}

			TextView name = (TextView) convertView.findViewById(cn.ucai.WePartyBar.R.id.name);
