...
public class ShowVideoActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.WePartyBar.R.layout.showvideo_activity);
		loadingLayout = (RelativeLayout) findViewById(cn.ucai.WePartyBar.R.id.loading_layout);
		progressBar = (ProgressBar) findViewById(cn.ucai.WePartyBar.R.id.progressBar);
