...
public class OfflinePushNickActivity extends BaseActivity {
	...
	protected void onCreate(Bundle arg0) {
		...
		super.onCreate(arg0);
		setContentView(cn.ucai.WePartyBar.R.layout.activity_offline_push);

		inputNickName = (EditText) findViewById(cn.ucai.WePartyBar.R.id.et_input_nickname);
		saveNickName = (Button) findViewById(cn.ucai.WePartyBar.R.id.btn_save);
		nicknameDescription = (TextView) findViewById(cn.ucai.WePartyBar.R.id.tv_nickname_description);
