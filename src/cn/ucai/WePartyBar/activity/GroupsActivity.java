...
import cn.ucai.WePartyBar.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
					...
					if (success) {
						...
						if (!GroupsActivity.this.isFinishing()) {
							String s1 = getResources()
									.getString(
											cn.ucai.WePartyBar.R.string.Failed_to_get_group_chat_information);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.WePartyBar.R.layout.fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(cn.ucai.WePartyBar.R.id.list);
		
		swipeRefreshLayout = (SwipeRefreshLayout) findViewById(cn.ucai.WePartyBar.R.id.swipe_layout);
		...
		progressBar = (View)findViewById(cn.ucai.WePartyBar.R.id.progress_bar);
